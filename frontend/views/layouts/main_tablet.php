...
<!DOCTYPE html><html lang="<?= Yii::$app->language ?>">
    <head>
        ...
        <meta charset="<?= Yii::$app->charset ?>"><meta content="IE=edge"http-equiv="X-UA-Compatible">
    ...
    <body>
        <?php $this->beginBody() ?>
        <header id="layouts_main_tablet">
            <?= topHeader::widget() ?><?= mainMenu::widget() ?>
        </header>
        <div id="layouts_main_tablet" class="slideshow">
            <?= slideShow::widget() ?>
        </div>
        <div id="layouts_main_tablet" class="main">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-2 col-xl-2">
                        <div class="right">
                            <?php if (isset(Yii::$app->params['settingModules']['content']['content_right'])): ?><?php foreach (Yii::$app->params['settingModules']['content']['content_right']as $value): ?><?php
        ...
        <div id="layouts_main_tablet"><?= footerWidget::widget() ?></div>
        <?= modalCartWidget::widget() ?><?php $this->endBody() ?>
        <?php
