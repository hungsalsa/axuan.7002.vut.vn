...
<nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    <li>
                        <a href="<?= Yii::$app->request->hostInfo ?>" target="_blank"><i class="ti-world fa-fw text-info"></i><span class="hide-menu text-info"><span class="hidden-xs">View Website</span></span></a>
                    </li>
                    <li>
