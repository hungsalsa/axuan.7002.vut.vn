    ...
    <div class="products-form">
        ...
        <?php $form = ActiveForm::begin([
                    ...
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            ...
                            <div class="clearfix"></div>
                                ...
                                <?= $form->field($model, 'short_introduction',['options'=>['id' => 'product_short_introduction']])->textarea(['rows' => 4]) ?>
                    ...
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <?= $form->field($model, 'highlights',['options' => ['class' => 'col-md-12']])->widget(CheckboxX::classname(),
                                ...
                                <?php $form->field($model, 'product_type_id',['options'=>['class'=>'col-md-11']])->widget(Select2::classname(), [
                                ...
                                <?php $form->field($model, 'supplier_id',['options'=>['class'=>'col-md-11']])->widget(Select2::classname(), [
                                    'data' => $data['suppliers'],
                                    'options' => ['placeholder' => 'Select a color ...'],
                                    'pluginOptions' => [
                                        'allowClear' => true,
            ...
            <div class="form-group btn_save">
                ...
                <?= Html::resetButton(Yii::t('app', 'Reset'), ['name' => 'cancel', 'class' => 'btn btn-primary btn_luu']) ?>
                <?= Html::a('Cancel', ['/products/default'], ['class'=>'btn btn-danger btn_luu']) ?>
            </div>
