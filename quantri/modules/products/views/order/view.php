...
$this->title = $model->khachhang->fullname;
...
<div class="order-view">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="panel panel-default">
            <div class="panel-heading"><h2>Thông tin đơn hàng: <?= $model->khachhang->fullname ?></h2></div>
                <div class="panel-body">
                    ...
                    <tbody>
                        <tr>
                            <td>Họ tên: <?= $model->khachhang->fullname ?></td>
                            <td>Số điện thoại: <?= $model->khachhang->phone ?></td>
                            <td>Địa chỉ: <?= $model->khachhang->address ?></td>
                            <td>Email: <?= $model->khachhang->email ?></td>
                        </tr>
                        <tr>
                            <td><?= $model->getAttributeLabel('created_at').' : '.Yii::$app->formatter->asDateTime($model->created_at); ?></td>
                            <td><?= $model->getAttributeLabel('updated_at').' : '.Yii::$app->formatter->asDateTime($model->updated_at); ?></td>
                            <td><b><?= $model->getAttributeLabel('userUpdated') ?>  : <?= isset($model->user->username)? $model->user->username : 'Chưa'; ?></b></td>
                            <td>Tình trạng đơn : <button id="orderStatus" onclick="changeStatusOrder(<?= $model->order_id ?>)" class="btn btn-outline btn-rounded btn-<?= ($model->status == 0) ?'danger':'info'?>"><?= ($model->status == 0) ? 'Chưa nhận đơn':' Đã nhận đơn ' ?></button> </td>
                        </tr>
