...
<div class="categories-index">
    ...
    <p class="btn_save">
        <?php //Html::a('Thêm mới', ['create'], ['class' => 'btn btn-success btn_luu']) ?>

        <?= Html::a('Thêm mới', ['create','parent_id'=>7,'title'=>'Downloads'], [
            'class' => 'btn btn-success btn_luu',
            // 'data'=>[
            //     // 'method' => 'post',
            //     'params'=>[
            //         'User[name]' => 'John',
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
               ...
               'format' => 'raw',
               'value'=>function ($data) {
                    return Html::a(Html::encode($data->cateName),Url::toRoute(['categories/update', 'id' => $data->id,'parent_id'=>7,'title'=>'Downloads']));
                },
            ],
            [
               'attribute' => 'parent_id',
            ...
            [
                ...
                'buttons' => [
                    'update' => function ($url, $model, $key) {
                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>', ['update', 'id'=>$model->id,'parent_id'=>7,'title'=>'Downloads'], ['title' => 'DS ảnh', 'data' => ['pjax' => 0]] );
                    },
                ],
            ],
        ],
